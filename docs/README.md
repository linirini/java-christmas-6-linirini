...
- [ ] 주문 메뉴와 개수 입력 - InputView#inputOrders
  - [x] "주문하실 메뉴를 메뉴와 개수를 알려 주세요. (e.g. 해산물파스타-2,레드와인-1,초코케이크-1)"
    - [ ] 주문 형식에 맞지 않을 경우 : "[ERROR] 유효하지 주문 형식입니다. 다시 입력해 주세요."
    - [ ] 주문 개수가 1이상이 아닌 경우 : "[ERROR] 주문하실 메뉴의 개수는 1개 이상이어야 합니다. 다시 입력해 주세요."
  - [ ] 주문 메뉴 입력
    - [ ] 음료만 주문 불가 
      -[ ] 음료만 주문하는 경우 : "[ERROR] 음료만 주문할 수 없습니다. 다시 입력해 주세요." - Orders#validate
    - [ ] 존재하지 않는 메뉴인 경우 : "[ERROR] 유효하지 않은 주문입니다. 다시 입력해 주세요." - Orders#validate
  - [ ] 주문 개수 입력
